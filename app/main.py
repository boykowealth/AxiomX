...
def handle_click(square_clicks, reset_clicks, player_color, promote_queen, promote_rook, promote_bishop, promote_knight, game_state):
    ...
    if player_color and player_color != game_state.get('player_color', 'white'):
        ...
        if player_color == 'black' and game_state['current_player'] == 'white' and not game_state.get('game_over'):
            ...
            return board_layout_wrapper, game_state, status, False, eval_bar, move_list
    ...
    if 'reset-button' in trigger_id:
        ...
        return board_layout_wrapper, new_state, status, False, eval_bar, move_list
    ...
    if game_state['game_over'] or game_state['current_player'] == ai_color or game_state['pending_promotion']:
        ...
        eval_bar = create_evaluation_bar(game_state['evaluation'])
        move_list = create_move_list(game_state['move_history'])
        return board_layout_wrapper, game_state, status, game_state['pending_promotion'] is not None, eval_bar, move_list
    ...
    if needs_promotion:
        ...
        eval_bar = create_evaluation_bar(game_state['evaluation'])
        move_list = create_move_list(game_state['move_history'])
        return board_layout_wrapper, game_state, "> SELECT PROMOTION", True, eval_bar, move_list
